  ...
  component: () => (
    ...
    >
      ...
      <div className="mt-12 flex flex-wrap gap-3">
        <Link
          to="/insights"
          className="btn-micro inline-flex h-11 items-center justify-center rounded-md border border-border bg-background px-6 text-sm font-semibold text-foreground hover:bg-muted"
        >
          Read more stories →
        </Link>
        <Link
